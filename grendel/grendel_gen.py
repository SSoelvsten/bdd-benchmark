...
BENCHMARKS = {
    ...
    "game-of-life": {
        dd_t.bdd: [
            ...
            [ [ 0, 0,10], "-o mirror-vertical -N 4 -N 4" ],
            ...
            [ [ 1, 0,00], "-o mirror-diagonal -N 6 -N 6" ],
            [ [15, 0,00], "-o mirror-diagonal -N 7 -N 7" ],
            # Mirror Double Diagonal
            [ [ 0, 0,10], "-o mirror-double_diagonal -N 3 -N 3" ],
            [ [ 0, 0,10], "-o mirror-double_diagonal -N 4 -N 4" ],
            [ [ 0, 0,10], "-o mirror-double_diagonal -N 5 -N 5" ],
            [ [ 0, 3,00], "-o mirror-double_diagonal -N 6 -N 6" ],
            [ [15, 0,00], "-o mirror-double_diagonal -N 7 -N 7" ],
            # Rotate 90
            [ [ 0, 0,10], "-o rotate-90 -N 3 -N 3" ],
            [ [ 0, 0,10], "-o rotate-90 -N 4 -N 4" ],
            [ [ 0, 0,10], "-o rotate-90 -N 5 -N 5" ],
            [ [ 0, 0,30], "-o rotate-90 -N 6 -N 6" ],
            # Rotate 180
            [ [ 0, 0,10], "-o rotate-180 -N 3 -N 3" ],
            [ [ 0, 0,10], "-o rotate-180 -N 4 -N 3" ],
            [ [ 0, 0,10], "-o rotate-180 -N 4 -N 4" ],
            [ [ 0, 0,10], "-o rotate-180 -N 5 -N 4" ],
            [ [ 0, 0,30], "-o rotate-180 -N 5 -N 5" ],
            [ [ 0, 1,00], "-o rotate-180 -N 6 -N 5" ],
            [ [ 2, 0,00], "-o rotate-180 -N 6 -N 6" ],
            [ [15, 0,00], "-o rotate-180 -N 7 -N 6" ],
        ]
    },
    # --------------------------------------------------------------------------
    "hamiltonian": {
