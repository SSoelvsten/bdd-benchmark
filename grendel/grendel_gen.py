    ...
    "picotrav": {
        dd_t.bdd: [
          ...
          # [ [15, 0, 0], picotrav__args(epfl_spec_t.arithmetic, epfl_opt_t.depth, "square",     picotrav_opt_t.LEVEL_DFS) ],
            ...
            [ [ 0, 0,10], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.size,  "mem_ctrl",   picotrav_opt_t.LEVEL_DFS) ],
            [ [ 0, 0,10], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.depth, "mem_ctrl",   picotrav_opt_t.LEVEL_DFS) ],
            ...
            [ [ 0, 2,00], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.size,  "voter",      picotrav_opt_t.LEVEL_DFS) ],
            [ [ 0, 2,00], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.depth, "voter",      picotrav_opt_t.LEVEL_DFS) ],
        ],
        dd_t.zdd: [
            # arithmetic
            [ [ 0, 0,10], picotrav__args(epfl_spec_t.arithmetic, epfl_opt_t.size,  "adder",      picotrav_opt_t.LEVEL_DFS) ],
          ...
          # [ [15, 0, 0], picotrav__args(epfl_spec_t.arithmetic, epfl_opt_t.depth, "square",     picotrav_opt_t.LEVEL_DFS) ],
            ...
            [ [ 0, 0,10], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.depth, "router",     picotrav_opt_t.INPUT) ],
            [ [ 0, 2,00], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.size,  "voter",      picotrav_opt_t.LEVEL_DFS) ],
            [ [ 0,12,00], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.depth, "voter",      picotrav_opt_t.LEVEL_DFS) ],
        ]
    },
    # --------------------------------------------------------------------------
    "qbf": {
