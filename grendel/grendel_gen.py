...
BENCHMARKS = {
    ...
    "knights_tour": {
        dd_t.zdd: [
            ...
            [ [ 0, 0,10], "-o CLOSED -N 8" ],
            [ [ 0, 0,10], "-o CLOSED -N 9" ],
            [ [ 0, 0,10], "-o CLOSED -N 10" ],
            [ [ 0, 0,10], "-o CLOSED -N 11" ],
            [ [ 0, 0,30], "-o CLOSED -N 12" ],
            [ [ 0, 2, 0], "-o CLOSED -N 13" ],
            [ [ 0, 0,10], "-o CLOSED -N 14" ],
            [ [15, 0, 0], "-o CLOSED -N 15" ],
            [ [15, 0, 0], "-o CLOSED -N 16" ],
        ]
    },
    # --------------------------------------------------------------------------
    "picotrav": {
        dd_t.bdd: [
          ...
          # [ [15, 0, 0], picotrav__args(epfl_spec_t.arithmetic, epfl_opt_t.size,  "bar",        picotrav_opt_t.LEVEL_DFS) ],
          # [ [15, 0, 0], picotrav__args(epfl_spec_t.arithmetic, epfl_opt_t.depth, "bar",        picotrav_opt_t.LEVEL_DFS) ],
          ...
          # [ [15, 0, 0], picotrav__args(epfl_spec_t.arithmetic, epfl_opt_t.depth, "square",     picotrav_opt_t.LEVEL_DFS) ],
            # random_control
            [ [ 0, 1, 0], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.size,  "arbiter",    picotrav_opt_t.LEVEL_DFS) ],
            [ [ 0, 2, 0], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.depth, "arbiter",    picotrav_opt_t.LEVEL_DFS) ],
            ...
            [ [ 0, 2, 0], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.size,  "mem_ctrl",   picotrav_opt_t.LEVEL_DFS) ],
            [ [ 0, 2, 0], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.depth, "mem_ctrl",   picotrav_opt_t.LEVEL_DFS) ],
            ...
            [ [ 1, 0,00], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.size,  "voter",      picotrav_opt_t.LEVEL_DFS) ],
            [ [ 0, 3,00], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.depth, "voter",      picotrav_opt_t.LEVEL_DFS) ],
        ],
        dd_t.zdd: [
            # arithmetic
            [ [ 0, 0,10], picotrav__args(epfl_spec_t.arithmetic, epfl_opt_t.size,  "adder",      picotrav_opt_t.LEVEL_DFS) ],
          ...
          # [ [15, 0, 0], picotrav__args(epfl_spec_t.arithmetic, epfl_opt_t.depth, "log2",       picotrav_opt_t.LEVEL_DFS) ],
          # [ [15, 0, 0], picotrav__args(epfl_spec_t.arithmetic, epfl_opt_t.size,  "max",        picotrav_opt_t.LEVEL_DFS) ],
            [ [ 9, 0, 0], picotrav__args(epfl_spec_t.arithmetic, epfl_opt_t.depth, "max",        picotrav_opt_t.LEVEL_DFS) ],
          # [ [15, 0, 0], picotrav__args(epfl_spec_t.arithmetic, epfl_opt_t.size,  "multiplier", picotrav_opt_t.LEVEL_DFS) ],
          # [ [15, 0, 0], picotrav__args(epfl_spec_t.arithmetic, epfl_opt_t.depth, "multiplier", picotrav_opt_t.LEVEL_DFS) ],
            [ [ 0, 3, 0], picotrav__args(epfl_spec_t.arithmetic, epfl_opt_t.size,  "sin",        picotrav_opt_t.LEVEL_DFS) ],
            [ [ 5, 0, 0], picotrav__args(epfl_spec_t.arithmetic, epfl_opt_t.depth, "sin",        picotrav_opt_t.LEVEL_DFS) ],
          ...
          # [ [15, 0, 0], picotrav__args(epfl_spec_t.arithmetic, epfl_opt_t.depth, "square",     picotrav_opt_t.LEVEL_DFS) ],
            ...
            [ [ 1, 0, 0], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.size,  "mem_ctrl",   picotrav_opt_t.LEVEL_DFS) ],
            [ [ 1, 0, 0], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.depth, "mem_ctrl",   picotrav_opt_t.LEVEL_DFS) ],
            [ [ 0, 0,10], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.size,  "priority",   picotrav_opt_t.INPUT) ],
            [ [ 0, 0,10], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.depth, "priority",   picotrav_opt_t.INPUT) ],
            [ [ 0, 0,10], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.size,  "router",     picotrav_opt_t.INPUT) ],
            [ [ 0, 0,10], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.depth, "router",     picotrav_opt_t.INPUT) ],
            [ [ 3, 0, 0], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.size,  "voter",      picotrav_opt_t.LEVEL_DFS) ],
            [ [ 2, 0, 0], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.depth, "voter",      picotrav_opt_t.LEVEL_DFS) ],
        ]
    },
    # --------------------------------------------------------------------------
    "qbf": {
